                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
                    {services.map((service, index) => (
                        <motion.div
                            ...
                            className="bg-white/60 backdrop-blur-sm border border-charcoal/10 p-8 rounded-3xl relative group shadow-sm hover:shadow-md transition-all flex flex-col w-full h-auto"
                        >
